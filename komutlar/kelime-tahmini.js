...
db.set(`Candy`,`Bu oyunu oynadığınız botun ismi.`)
...
db.set(`Senqaii`, `Botun Yapımcısı`)
//kelime haznesi (açıklamalar)

//Amil <3 ///////////////////
      var kelimeler = ['Klostrofobi','Türkçe','Domates','Otel','Söğüt','Veteriner','Candy','Rythm','Magnum','Lüksemburg','Deve', 'Senqaii'];
